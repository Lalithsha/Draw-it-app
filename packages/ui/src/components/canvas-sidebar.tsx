  ...
  return (
    <div className="text-xs text-neutral-700 dark:text-neutral-300">
      ...
      <div
        ...
        className="inline-flex items-center gap-1 rounded-md border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 p-1"
      >
        <ThemeModeButton
