        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="max-w-xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              ...
              <span className="text-excali-purple font-handwritten ml-2">
                Draw-It-Out
              </span>
            </h1>
            <p className="text-lg text-gray-700 mb-8">
              The simple, intuitive whiteboard tool that makes collaboration
              easy. Sketch, share, and brainstorm together in real-time.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button
                variant="outline"
                className="border-excali-purple text-excali-purple hover:bg-excali-purple/10 px-8 py-6 text-lg"
              >
                Watch Demo
              </Button>
            </div>
            ...
            <div className="relative hand-drawn bg-white p-4 excali-shadow rounded-lg border-2 border-gray-200 animate-float">
              <div className="relative bg-white">
                ...
                >
                  ...
                  <path
                    d="M100,100 Q150,50 200,150 T300,200 T400,250"
                    stroke="#4A87FF"
                    strokeWidth="3"
                    fill="none"
                    strokeLinecap="round"
